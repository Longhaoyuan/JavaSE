...
public class Test02 {
  public static void main(String[] args) {
    ...
    System.out.println("str1和str3内容是否相等："+str3.equals(str1));
    ...
    System.out.println("str1字符串是否以o后缀开头："+str1.endsWith("o"));
    System.out.println("str1字符串是否以l后缀开头："+str1.endsWith("l"));
  }
}
